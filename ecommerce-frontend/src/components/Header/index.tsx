...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Cães", value: "1" },
    { label: "Gatos", value: "2" },
    { label: "Peixes", value: "3" },
    { label: "Silvestres", value: "4" },
    { label: "Decorações", value: "5" },
    { label: "Utilidades", value: "6" },
    { label: "Promoções", value: "7" },
  ];


  return (
    <header
      className={`fixed left-0 top-0 w-full z-9999 bg-white transition-all ease-in-out duration-300 ${stickyMenu && "shadow-md"
        }`}
    >
        ...
        >
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-gray-100 !border-l-0 border border-gray-300 py-2.5 pl-4 pr-10 outline-none ease-in duration-200 focus:border-[#376f8a]"
                    />

                    <button
                      id="search-btn"
                      aria-label="Search"
                      className="flex items-center justify-center absolute right-3 top-1/2 -translate-y-1/2 ease-in duration-200 hover:text-[#375d8a]"
                    >
                      <svg
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                <Link href="https://wa.me/551128351614">
                  <span className="block text-2xs text-gray-600 uppercase">
                    Suporte
                  </span>
                  <p className="font-medium text-custom-sm text-[#274766] hover:text-[#375d8a]">
                    Clique aqui!
                  </p>
                </Link>
              </div>
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                  ...
                  <div className="flex items-center gap-2.5 group relative">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M20 20C20 16.6863 16.6863 14 12 14C7.3137 14 4 16.6863 4 20"
                          stroke="#376f8a"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                    ...
                    <div className="absolute hidden group-hover:block top-full right-0 bg-white shadow-lg rounded-md p-2 min-w-[160px] z-10">
                      <div className="px-4 py-2 border-b border-gray-200">
                        <p className="text-sm font-medium text-[#274766]">{user?.nome}</p>
                      ...
                      <Link
                        href="/minha-conta"
                        className="block px-4 py-2 text-sm text-[#274766] hover:bg-gray-100 hover:text-[#375d8a]"
                      >
                        Minha Conta
                      </Link>
                      <button
                        onClick={handleLogout}
                        className="w-full text-left px-4 py-2 text-sm text-[#274766] hover:bg-gray-100 hover:text-[#375d8a]"
                      >
                        Sair
                      </button>
                    </div>
                ...
                <span className="hidden lg:block w-px h-7 bg-black-200"></span>
                ...
                >
                  <span className="inline-block relative">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M7.5 13.5H19.1925C19.2795 13.5 19.3665 13.47 19.4295 13.41C19.563 13.2825 19.575 13.0725 19.4475 12.9375L16.35 9.4125C16.245 9.2925 16.08 9.2325 15.9225 9.2625L11.25 10.125"
                        stroke="#375d8a"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-[#375d8a] w-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
                  <div>
              ...
              >
                <span className="block relative cursor-pointer w-5.5 h-5.5">
                  <span className="du-block absolute right-0 w-full h-full">
                    <span
                      className={`block relative top-0 left-0 bg-[#274766] rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-[0] ${!navigationOpen && "!w-full delay-300"
                        }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 bg-[#274766] rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-150 ${!navigationOpen && "!w-full delay-400"
                        }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 bg-[#274766] rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-200 ${!navigationOpen && "!w-full delay-500"
                        }`}
                    ></span>
                  </span>
                  ...
                  <span className="block absolute right-0 w-full h-full rotate-45">
                    <span
                      className={`block bg-[#274766] rounded-sm ease-in-out duration-200 delay-300 absolute left-2.5 top-0 w-0.5 h-full ${!navigationOpen && "!h-0 delay-[0] "
                        }`}
                    ></span>
                    <span
                      className={`block bg-[#274766] rounded-sm ease-in-out duration-200 delay-400 absolute left-0 top-2.5 w-full h-0.5 ${!navigationOpen && "!h-0 dealy-200"
                        }`}
                    ></span>
                  </span>
                </span>
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-[#375d8a] text-custom-sm font-medium text-[#274766] flex ${stickyMenu ? "xl:py-4" : "xl:py-6"
                            }`}
                        >
                          {menuItem.title}
                        </Link>
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                <li className="py-4">
                  <a
                    href="#"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-[#274766] hover:text-[#375d8a]"
                  >
                    <svg
                      className="fill-current"
                      width="16"
